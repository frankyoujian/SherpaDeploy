...
#ifndef SHERPA_DEPLOY_OPENVINO_RECOGNIZER_H_
#define SHERPA_DEPLOY_OPENVINO_RECOGNIZER_H_
...
struct RecognizerConfig {
  SherpaDeploy::FeatureExtractorConfig feat_config;
  ModelConfig model_config;
  DecoderConfig decoder_config;
  SherpaDeploy::EndpointConfig endpoint_config;
  ...
  RecognizerConfig(const SherpaDeploy::FeatureExtractorConfig &feat_config,
                   const ModelConfig &model_config,
                   const DecoderConfig decoder_config,
                   const SherpaDeploy::EndpointConfig &endpoint_config, bool enable_endpoint,
...
#endif  // SHERPA_DEPLOY_OPENVINO_RECOGNIZER_H_
