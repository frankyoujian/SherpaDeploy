...
#ifndef SHERPA_DEPLOY_CORE_FEATURES_H_
#define SHERPA_DEPLOY_CORE_FEATURES_H_
...
class FeatureExtractor {
 public:
   ...
   * @return Return a tuple(flattened features_vector, feature_dim)       
   */
...
#endif  // SHERPA_DEPLOY_CORE_FEATURES_H_
