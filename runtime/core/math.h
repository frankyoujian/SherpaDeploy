...
#ifndef SHERPA_DEPLOY_CORE_MATH_H_
#define SHERPA_DEPLOY_CORE_MATH_H_
...
// logf(FLT_EPSILON)
#define SHERPA_DEPLOY_MIN_LOG_DIFF_FLOAT -15.9423847198486328125f

// log(DBL_EPSILON)
#define SHERPA_DEPLOY_MIN_LOG_DIFF_DOUBLE \
...
struct LogAdd<double> {
  double operator()(double x, double y) const {
    ...
    if (diff >= SHERPA_DEPLOY_MIN_LOG_DIFF_DOUBLE) {
      double res;
...
#endif  // SHERPA_DEPLOY_CORE_MATH_H_
