...
#ifndef SHERPA_DEPLOY_MNN_STREAM_H_
#define SHERPA_DEPLOY_MNN_STREAM_H_
...
class Stream {
 public:
  ...
  void SetStates(const std::vector<TensorPtr> &states);
  std::vector<TensorPtr> &GetStates();
  /**
...
#endif  // SHERPA_DEPLOY_MNN_STREAM_H_
